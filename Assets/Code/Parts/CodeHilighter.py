...
def format(color, style=''):
    ...
    if 'bold' in style:
        _format.setFontWeight(PyQt5.QtGui.QFont.Bold)
    if 'italic' in style:
...
class PythonHighlighter (PyQt5.QtGui.QSyntaxHighlighter):
    ...
    def __init__(self, parent: PyQt5.QtGui.QTextDocument) -> None:
        ...
        self.tri_single = (PyQt5.QtCore.QRegExp("'''"), 1, STYLES['string2'])
        self.tri_double = (PyQt5.QtCore.QRegExp('"""'), 2, STYLES['string2'])
        ...
        self.rules = [(PyQt5.QtCore.QRegExp(pat), index, fmt)
